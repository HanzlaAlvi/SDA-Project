...
public:
    ...
    void calculateGrade(Student &s) const
    {
        float total = 0;
...
public:
    explicit StudentOperations(shared_ptr<IGradeStrategy> strategy)
...
public:
    ExtendedStudentOperations(shared_ptr<IGradeStrategy> gradeStrategy,
...
public:
    MenuSystem()
    {
        ...
        ops = make_unique<ExtendedStudentOperations>(
            gradeStrategy, exporter, reportGen);
